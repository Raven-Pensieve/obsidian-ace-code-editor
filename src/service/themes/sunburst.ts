...
.ace-sunburst .ace_keyword{color:#E28964;}
.ace-sunburst .ace_constant{color:#3387CC;}
.ace-sunburst .ace_support{color:#9B859D;}
.ace-sunburst .ace_support.ace_function{color:#DAD085;}
.ace-sunburst .ace_support.ace_constant{color:#CF6A4C;}
.ace-sunburst .ace_storage{color:#99CF50;}
.ace-sunburst .ace_invalid.ace_illegal{color:#FD5FF1;
background-color:rgba(86, 45, 86, 0.75);}
.ace-sunburst .ace_invalid.ace_deprecated{text-decoration:underline;
font-style:italic;
color:#FD5FF1;}
.ace-sunburst .ace_string{color:#65B042;}
.ace-sunburst .ace_string.ace_regexp{color:#E9C062;}
.ace-sunburst .ace_comment{font-style:italic;
color:#AEAEAE;}
.ace-sunburst .ace_variable{color:#3E87E3;}
.ace-sunburst .ace_meta.ace_tag{color:#89BDFF;}
.ace-sunburst .ace_markup.ace_heading{color:#FEDCC5;
