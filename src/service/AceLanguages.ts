...
export const languageModeMap = {
	...
	asl: ["asl"],
	assembly_arm32: ["assembly_arm32", "s", "asm"],
	assembly_x86: ["assembly_x86"],
	astro: ["astro"],
	autohotkey: ["autohotkey", "ahk"],
	basic: ["basic", "bas"],
	batchfile: ["batchfile", "bat", "cmd", "batch"],
	bibtex: ["bibtex", "bib"],
	c9search: ["c9search"],
	cirru: ["cirru"],
	...
	c_cpp: ["c_cpp", "c", "h", "cpp", "c++", "cc", "cxx", "hxx", "hpp", "hh"],
	d: ["d"],
	dart: ["dart"],
	diff: ["diff"],
	django: ["django"],
	...
	flix: ["flix"],
	forth: ["forth"],
	fortran: ["fortran", "f", "for", "f90"],
	fsharp: ["fsharp", "fs", "fsi", "ml", "mli", "fsx", "fsscript"],
	fsl: ["fsl"],
	ftl: ["ftl"],
	gcode: ["gcode"],
	gherkin: ["gherkin"],
	...
	jade: ["jade"],
	java: ["java", "jav"],
	javascript: ["javascript", "js", "es6", "mjs"],
	jexl: ["jexl"],
	json: ["json"],
	json5: ["json5"],
	jsoniq: ["jsoniq"],
	...
	nsis: ["nsis"],
	nunjucks: ["nunjucks"],
	objectivec: ["objectivec", "m", "objective-c"],
	ocaml: ["ocaml"],
	odin: ["odin"],
	partiql: ["partiql"],
	pascal: ["pascal"],
	...
	qml: ["qml"],
	r: ["r", "R", "rhistory", "rprofile", "rmd", "rt"],
	raku: ["raku"],
	razor: ["razor", "cshtml"],
	rdoc: ["rdoc"],
	red: ["red"],
	...
	ruby: ["ruby", "rb", "rbx", "rjs", "gemspec"],
	rust: ["rust", "rs", "rlib"],
	sac: ["sac"],
	sass: ["sass"],
	scad: ["scad"],
	scala: ["scala", "sc", "sbt"],
	scheme: ["scheme", "scm", "ss", "sch", "rkt"],
	scrypt: ["scrypt"],
	scss: ["scss"],
	sh: ["sh", "bash", "shell"],
	sjs: ["sjs"],
...
export const languageWorkerMap = [
	"coffee",
	"css",
	"html",
	"javascript",
